                    ...
                    <div class="owl-carousel testimonial-carousel" id="testimonial-carousel-2">
                        <div class="cps-testimonial-item">
                            <div class="cps-commenter-pic">
                                <img src="./images/client/aCommerce Logo.png" alt="...">
                            </div>
                            <blockquote>CSTECH Solution keeps his service level high and is always ready whenever we face any technical difficulties.</blockquote>
                            <h5 class="cps-reviewer-name">Derek Burke</h5>
                            <p class="cps-reviewer-position">General Manager</p>
                            <p class="cps-reviewer-company">aCommerce Singapore</p>
                        </div>
                        <div class="cps-testimonial-item">
                            <div class="cps-commenter-pic">
                            ...
                            <p class="cps-reviewer-position">Director</p>
                            <p class="cps-reviewer-company">888 mookata</p>
                        </div>
                        <div class="cps-testimonial-item">
                            ...
                            <p class="cps-reviewer-position">Director</p>
                            <p class="cps-reviewer-company">Deasco Offshore and Marine</p>
                        </div>
                        <div class="cps-testimonial-item">
                            ...
                            <p class="cps-reviewer-position">Director</p>
                            <p class="cps-reviewer-company">Global Training Services</p>
                        </div>
                        <div class="cps-testimonial-item">
                            <div class="cps-commenter-pic rect">
                            ...
                            <p class="cps-reviewer-position">PA to Chairman</p>
                            <p class="cps-reviewer-company">HLN Rubber Products</p>
                        </div>
                        <div class="cps-testimonial-item">
                            <div class="cps-commenter-pic rect">
                            ...
                            <p class="cps-reviewer-position">Finance Manager</p>
                            <p class="cps-reviewer-company">Sinjia Land limited</p>
                        </div>
                        <div class="cps-testimonial-item">
                            <div class="cps-commenter-pic rect">
                            ...
                            <p class="cps-reviewer-position">Founder</p>
                        ...
                        <div class="cps-testimonial-item">
                            ...
                            <p class="cps-reviewer-position">Facilities Manager</p>
                            <p class="cps-reviewer-company">West Connect Building</p>
                        </div>
                    </div>
                </div>
            </div>
